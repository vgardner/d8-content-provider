...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'basic_auth.page_cache_request_policy.disallow_basic_auth_requests' => 'getBasicAuth_PageCacheRequestPolicy_DisallowBasicAuthRequestsService',
    ...
    {
        $this->services['authentication.basic_auth'] = $instance = new \Drupal\basic_auth\Authentication\Provider\BasicAuth($this->get('config.factory'), $this->get('user.auth'), $this->get('flood'), $this->get('entity.manager'));

        $instance->_serviceId = 'authentication.basic_auth';
    ...
    /**
     * Gets the 'basic_auth.page_cache_request_policy.disallow_basic_auth_requests' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Drupal\basic_auth\PageCache\DisallowBasicAuthRequests A Drupal\basic_auth\PageCache\DisallowBasicAuthRequests instance.
     */
    protected function getBasicAuth_PageCacheRequestPolicy_DisallowBasicAuthRequestsService()
    {
        $this->services['basic_auth.page_cache_request_policy.disallow_basic_auth_requests'] = $instance = new \Drupal\basic_auth\PageCache\DisallowBasicAuthRequests();

        $instance->_serviceId = 'basic_auth.page_cache_request_policy.disallow_basic_auth_requests';
    ...
    protected function getPageCacheRequestPolicyService()
    {
        ...
        $instance->addPolicy($this->get('basic_auth.page_cache_request_policy.disallow_basic_auth_requests'));
